  ...
  const projects: Project[] = [
    {
      ...
      subtitle: "Notes App",
      description:
        "I built a full-stack note-taking application using the MERN Stack (MongoDB, Express.js, React, Node.js) with JWT-based user authentication. Developed core features including adding, deleting, and favoriting notes for efficient and intuitive note management. Designed a responsive user interface with Tailwind CSS and implemented smooth client-side routing using React Router DOM. Utilized Axios for handling API requests and integrated Express.js to manage the server-side logic.",
      technologies: [
        "React",
        "React Router Dom",
        "Tailwind CSS",
      ...
      viewLink: "https://github.com/onurvn/mern-notes-app",
      githubLink: "https://github.com/onurvn/mern-notes-app",
    },
    {
      id: 2,
      ...
      description:
        "I developed a real estate application using Next.js for server-side rendering, React for dynamic front-end components, and MongoDB for efficient data storage.Integrated Clerk for secure user authentication, enabling users to easily register, log in, and manage their profiles. Allowed users to add new property listings with details such as price, location, and images, leveraging Firebase for real-time data handling and cloud storage.",
      technologies: [
        "React",
        "Tailwind CSS",
        "Next.js",
      ...
      viewLink: "https://real-estate-app-eight-orpin.vercel.app/",
      githubLink: "https://github.com/onurvn/real-estate-app",
    },
    {
      id: 3,
      title: "Twitch Clone",
      ...
      description:
        "I developed a Front-End clone of the Twitch platform using React, Styled Components, and React Router. Aimed to replicate Twitch’s layout and design by building a responsive and dynamic user interface.Delivered an interactive browsing experience using modern web technologies.",
      technologies: [
        "React",
        "Redux",
        "Redux Toolkit",
      ...
      viewLink: "https://twitch-clone-weld.vercel.app/",
      githubLink: "https://github.com/onurvn/twitch-clone",
    },
  ];
    ...
    <div className="py-12 px-4 relative min-h-screen flex flex-col items-center">
      ...
      >
        ...
        <p className="text-lg mb-12 max-w-2xl opacity-80">
          A selection of my recent work. Each project represents different
          challenges and technologies I&apos;ve worked with.
        </p>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              >
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="relative h-72 md:h-auto overflow-hidden group">
                    <div className="absolute inset-0 bg-[#333] flex items-center justify-center">
                      ...
                      <div className="text-white text-center transition-all transform group-hover:scale-110 duration-300">
                        ...
                        <span className="text-3xl font-bold px-3">
                          {project.title}
                        </span>
                        <span className="text-[#FE5D26] text-5xl font-bold">{`}`}</span>
                      </div>
                  ...
                  <div className="p-8 flex flex-col">
                    <div className="mb-3">
                      <h2 className="text-2xl font-bold text-[#FE5D26]">
                        {project.title}
                      </h2>
                      <p className="text-gray-400">{project.subtitle}</p>
                    </div>

                    <p className="text-gray-300 mb-6 flex-grow text-justify">
                      {project.description}
                    </p>

                    <div className="mb-6">
                      <h3 className="text-sm text-[#FE5D26] mb-2 font-mono">
                        Technologies Used:
                      </h3>
                ...
                {/* Progress Indicator */}
                <div
                  className={`h-1 bg-[#FE5D26] transition-all duration-700 ${
              ...
              <div className="absolute -top-10 -left-4 opacity-20 select-none pointer-events-none z-0">
                <span className="text-[8rem] font-bold text-[#FE5D26]">
                  {project.id}
                </span>
              </div>
            </div>
