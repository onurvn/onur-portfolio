...
export default function About() {
  ...
  const toolsTech = [
    ...
    { name: "npm", checked: true },
    { name: "yarn", checked: true },
  ];

  return (
    <div className="py-12 px-4 relative min-h-screen flex flex-col items-center font-inter">
      ...
      >
        <AnimatedText
          text="// About Me"
          el="h1"
          className="text-4xl font-bold mb-8 text-[#FE5D26] font-inter"
          animation="fade"
        />

        <p className="text-lg mb-12 max-w-2xl opacity-80 font-inter">
          ...
          <div className="md:col-span-1">
            ...
            >
              <div className="p-6 space-y-8">
                <div>
                  <h3 className="text-xl mb-4 text-[#FE5D26] font-semibold">
                    Navigation
                  </h3>
          ...
          <div className="md:col-span-3">
            ...
            >
              <div className="bg-gradient-to-br from-[#111] to-[#1a1a1a] rounded-xl overflow-hidden border border-[#333] shadow-xl mb-12">
                {activeSection === "bio" && (
                  <div className="p-8">
                    <h2 className="text-2xl font-bold mb-6 text-[#FE5D26]">
                      Biography
                    </h2>
                    <div className="space-y-4 text-gray-300">
                      <p className="text-lg">
                        Hi, and welcome to my portfolio. I&apos;m a front-end
                        developer with a growing interest in modern web
                        technologies like React, Next.js, and TypeScript.
                      </p>
                      <p className="text-lg">
                        Over time, I&apos;ve been building responsive and
                        user-friendly web applications, with an emphasis on
                        clean code and practical design choices.
                      </p>
                      <p className="text-lg">
                        Along the way, I&apos;ve worked with backend tools such
                        as Node.js and used databases like PostgreSQL and
                        MongoDB in various projects.
                      </p>
                      <p className="text-lg">
                        Lately, I&apos;ve been exploring Go and learning more
                        about microservices as I continue to develop my skills
                        and work on building more scalable applications.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {activeSection === "interests" && (
                  <div className="p-8">
                    ...
                    <div className="space-y-4 text-gray-300">
                      <p className="text-lg">
                        I have a deep passion for front-end development,
                        particularly creating fluid animations and interactive
                        user interfaces using React and modern CSS frameworks.
                      </p>
                      <p className="text-lg">
                        I&apos;m enthusiastic about mobile development with
                        React Native and Expo, building cross-platform
                        applications with native-like experiences.
                      </p>
                      <p className="text-lg">
                        Recently, I&apos;ve become fascinated with server-side
                        rendering frameworks like Next.js and Astro, exploring
                        their capabilities for building performant web
                        applications.
                      </p>
                      <p className="text-lg">
                        In my free time, I contribute to open-source projects
                        and stay updated with the latest developments in web
                        technologies.
                      </p>
                    </div>
                  </div>
                ...
                {activeSection === "education" && (
                  <div className="p-8">
                    ...
                    <div className="space-y-4 text-gray-300">
                      <p className="text-lg">
                        I&apos;ve earned certifications in areas like
                        JavaScript, React, Node.js, and database management,
                        reflecting my commitment to learning and growth.
                      </p>
                      <p className="text-lg">
                        To keep my skills up to date, I regularly take part in
                        online courses and workshops—most recently focusing on
                        TypeScript, Go, and cloud deployment practices.
                      </p>
                      <p className="text-lg">
                        I&apos;m a strong believer in continuous learning and
                        enjoy attending tech conferences and local meetups to
                        stay connected with the latest trends in the industry.
                      </p>
                    </div>
                  </div>
                )}
                      ...
                      <div
                        ...
                        className={`p-3 border rounded-lg transition-all duration-300 ${
                          hoveredSkill === tech.name
                            ? "bg-orange-500/10 border-orange-400 scale-105"
                            : "border-[#333] hover:border-[#444] hover:bg-[#222]"
                        }`}
                        style={{
                          transitionDelay: `${index * 50}ms`,
                          opacity: skillsVisible ? 1 : 0,
                          transform: skillsVisible
                            ? "none"
                            : "translateY(10px)",
                        }}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {backendTech.map((tech, index) => (
                      <div
                        ...
                        className={`p-3 border rounded-lg transition-all duration-300 ${
                          hoveredSkill === tech.name
                            ? "bg-green-500/10 border-green-400 scale-105"
                            : "border-[#333] hover:border-[#444] hover:bg-[#222]"
                        }`}
                        style={{
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {toolsTech.map((tech, index) => (
                      <div
                        ...
                        className={`p-3 border rounded-lg transition-all duration-300 ${
                          hoveredSkill === tech.name
                            ? "bg-blue-500/10 border-blue-400 scale-105"
                            : "border-[#333] hover:border-[#444] hover:bg-[#222]"
                        }`}
                        style={{
